...
unsigned char *MD5::raw_digest(){
  ...
  // XXX: the original version new'd a buffer
  // which resulted in memory leaks. 
  // Changed it so a static buffer is returned instead.
  // Caller MUST NOT DEALLOCATE the returned value and
  // MUST COPY it if the caller plans to use it for a
  // long time.
...
char *MD5::hex_digest(){
  ...
  // XXX: the original version new'd a string
  // which resulted in memory leaks. 
  // Changed it so a static buffer is returned instead.
  // Caller MUST NOT DEALLOCATE the returned value and
  // MUST COPY it if the caller plans to use it for a
