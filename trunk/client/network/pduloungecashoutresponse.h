#ifndef __network_pduloungecashoutresponse_h__
#define __network_pduloungecashoutresponse_h__
...
struct PDULoungeCashOutReply : public PDUHeader
{
  ...
  PDULoungeCashOutReply(const char* buf)
    :
    PDUHeader (buf),
    indicator_(0)
  {
  ...
  void checkValid()
  {
    PDU_DEBUG("--- Recv: Lounge Cash Out Reply PDU ---");
