...
PLATFORM=VC-WIN32
CC=cl
CFLAG= /MDd /W3 /WX /Zi /Yd /Od /nologo -DWIN32 -D_DEBUG -DL_ENDIAN -DWIN32_LEAN_AND_MEAN -DDEBUG -DDSO_WIN32 /Fdout32dll
APP_CFLAG=
...
CRYPTOOBJ=$(OBJ_D)\cryptlib.obj \
	...
	$(OBJ_D)\ebcdic.obj $(OBJ_D)\uid.obj $(OBJ_D)\md2_dgst.obj \
	...
	$(OBJ_D)\rsa_chk.obj $(OBJ_D)\rsa_null.obj $(OBJ_D)\dsa_gen.obj \
	...
	$(OBJ_D)\rand_win.obj $(OBJ_D)\err.obj $(OBJ_D)\err_all.obj \
	...
	$(OBJ_D)\e_des3.obj $(OBJ_D)\e_rc4.obj $(OBJ_D)\names.obj \
	...
	$(OBJ_D)\t_bitst.obj $(OBJ_D)\p7_i_s.obj $(OBJ_D)\p7_signi.obj \
	...
	$(OBJ_D)\p8_pkey.obj $(OBJ_D)\pem_sign.obj $(OBJ_D)\pem_seal.obj \
	$(OBJ_D)\pem_info.obj $(OBJ_D)\pem_lib.obj $(OBJ_D)\pem_all.obj \
	$(OBJ_D)\pem_err.obj $(OBJ_D)\x509_def.obj $(OBJ_D)\x509_d2.obj \
	...
	$(OBJ_D)\v3_purp.obj $(OBJ_D)\v3_info.obj $(OBJ_D)\conf_err.obj \
...
$(OBJ_D)\md4_dgst.obj: $(SRC_D)\crypto\md4\md4_dgst.c
	$(CC) /Fo$(OBJ_D)\md4_dgst.obj  $(SHLIB_CFLAGS) -c $(SRC_D)\crypto\md4\md4_dgst.c

$(OBJ_D)\md4_one.obj: $(SRC_D)\crypto\md4\md4_one.c
	$(CC) /Fo$(OBJ_D)\md4_one.obj  $(SHLIB_CFLAGS) -c $(SRC_D)\crypto\md4\md4_one.c
...
$(OBJ_D)\rsa_null.obj: $(SRC_D)\crypto\rsa\rsa_null.c
	$(CC) /Fo$(OBJ_D)\rsa_null.obj  $(SHLIB_CFLAGS) -c $(SRC_D)\crypto\rsa\rsa_null.c
...
$(OBJ_D)\dso_dl.obj: $(SRC_D)\crypto\dso\dso_dl.c
	$(CC) /Fo$(OBJ_D)\dso_dl.obj  $(SHLIB_CFLAGS) -c $(SRC_D)\crypto\dso\dso_dl.c

$(OBJ_D)\dso_dlfcn.obj: $(SRC_D)\crypto\dso\dso_dlfcn.c
	$(CC) /Fo$(OBJ_D)\dso_dlfcn.obj  $(SHLIB_CFLAGS) -c $(SRC_D)\crypto\dso\dso_dlfcn.c

$(OBJ_D)\dso_err.obj: $(SRC_D)\crypto\dso\dso_err.c
	$(CC) /Fo$(OBJ_D)\dso_err.obj  $(SHLIB_CFLAGS) -c $(SRC_D)\crypto\dso\dso_err.c

$(OBJ_D)\dso_lib.obj: $(SRC_D)\crypto\dso\dso_lib.c
	$(CC) /Fo$(OBJ_D)\dso_lib.obj  $(SHLIB_CFLAGS) -c $(SRC_D)\crypto\dso\dso_lib.c

$(OBJ_D)\dso_null.obj: $(SRC_D)\crypto\dso\dso_null.c
	$(CC) /Fo$(OBJ_D)\dso_null.obj  $(SHLIB_CFLAGS) -c $(SRC_D)\crypto\dso\dso_null.c

$(OBJ_D)\dso_openssl.obj: $(SRC_D)\crypto\dso\dso_openssl.c
	$(CC) /Fo$(OBJ_D)\dso_openssl.obj  $(SHLIB_CFLAGS) -c $(SRC_D)\crypto\dso\dso_openssl.c

$(OBJ_D)\dso_win32.obj: $(SRC_D)\crypto\dso\dso_win32.c
	$(CC) /Fo$(OBJ_D)\dso_win32.obj  $(SHLIB_CFLAGS) -c $(SRC_D)\crypto\dso\dso_win32.c

$(OBJ_D)\dso_vms.obj: $(SRC_D)\crypto\dso\dso_vms.c
	$(CC) /Fo$(OBJ_D)\dso_vms.obj  $(SHLIB_CFLAGS) -c $(SRC_D)\crypto\dso\dso_vms.c
...
$(OBJ_D)\rand_err.obj: $(SRC_D)\crypto\rand\rand_err.c
	$(CC) /Fo$(OBJ_D)\rand_err.obj  $(SHLIB_CFLAGS) -c $(SRC_D)\crypto\rand\rand_err.c

$(OBJ_D)\rand_egd.obj: $(SRC_D)\crypto\rand\rand_egd.c
	$(CC) /Fo$(OBJ_D)\rand_egd.obj  $(SHLIB_CFLAGS) -c $(SRC_D)\crypto\rand\rand_egd.c

$(OBJ_D)\rand_win.obj: $(SRC_D)\crypto\rand\rand_win.c
	$(CC) /Fo$(OBJ_D)\rand_win.obj  $(SHLIB_CFLAGS) -c $(SRC_D)\crypto\rand\rand_win.c
...
$(OBJ_D)\e_des.obj: $(SRC_D)\crypto\evp\e_des.c
	$(CC) /Fo$(OBJ_D)\e_des.obj  $(SHLIB_CFLAGS) -c $(SRC_D)\crypto\evp\e_des.c

$(OBJ_D)\e_bf.obj: $(SRC_D)\crypto\evp\e_bf.c
	$(CC) /Fo$(OBJ_D)\e_bf.obj  $(SHLIB_CFLAGS) -c $(SRC_D)\crypto\evp\e_bf.c

$(OBJ_D)\e_idea.obj: $(SRC_D)\crypto\evp\e_idea.c
	$(CC) /Fo$(OBJ_D)\e_idea.obj  $(SHLIB_CFLAGS) -c $(SRC_D)\crypto\evp\e_idea.c
...
$(OBJ_D)\e_rc2.obj: $(SRC_D)\crypto\evp\e_rc2.c
	$(CC) /Fo$(OBJ_D)\e_rc2.obj  $(SHLIB_CFLAGS) -c $(SRC_D)\crypto\evp\e_rc2.c

$(OBJ_D)\e_cast.obj: $(SRC_D)\crypto\evp\e_cast.c
	$(CC) /Fo$(OBJ_D)\e_cast.obj  $(SHLIB_CFLAGS) -c $(SRC_D)\crypto\evp\e_cast.c

$(OBJ_D)\e_rc5.obj: $(SRC_D)\crypto\evp\e_rc5.c
	$(CC) /Fo$(OBJ_D)\e_rc5.obj  $(SHLIB_CFLAGS) -c $(SRC_D)\crypto\evp\e_rc5.c
...
$(OBJ_D)\m_md4.obj: $(SRC_D)\crypto\evp\m_md4.c
	$(CC) /Fo$(OBJ_D)\m_md4.obj  $(SHLIB_CFLAGS) -c $(SRC_D)\crypto\evp\m_md4.c
...
$(OBJ_D)\a_mbstr.obj: $(SRC_D)\crypto\asn1\a_mbstr.c
	$(CC) /Fo$(OBJ_D)\a_mbstr.obj  $(SHLIB_CFLAGS) -c $(SRC_D)\crypto\asn1\a_mbstr.c

$(OBJ_D)\a_strex.obj: $(SRC_D)\crypto\asn1\a_strex.c
	$(CC) /Fo$(OBJ_D)\a_strex.obj  $(SHLIB_CFLAGS) -c $(SRC_D)\crypto\asn1\a_strex.c
...
$(OBJ_D)\x_x509a.obj: $(SRC_D)\crypto\asn1\x_x509a.c
	$(CC) /Fo$(OBJ_D)\x_x509a.obj  $(SHLIB_CFLAGS) -c $(SRC_D)\crypto\asn1\x_x509a.c
...
$(OBJ_D)\t_x509a.obj: $(SRC_D)\crypto\asn1\t_x509a.c
	$(CC) /Fo$(OBJ_D)\t_x509a.obj  $(SHLIB_CFLAGS) -c $(SRC_D)\crypto\asn1\t_x509a.c
...
$(OBJ_D)\t_bitst.obj: $(SRC_D)\crypto\asn1\t_bitst.c
	$(CC) /Fo$(OBJ_D)\t_bitst.obj  $(SHLIB_CFLAGS) -c $(SRC_D)\crypto\asn1\t_bitst.c
...
$(OBJ_D)\a_strnid.obj: $(SRC_D)\crypto\asn1\a_strnid.c
	$(CC) /Fo$(OBJ_D)\a_strnid.obj  $(SHLIB_CFLAGS) -c $(SRC_D)\crypto\asn1\a_strnid.c
...
$(OBJ_D)\x509spki.obj: $(SRC_D)\crypto\x509\x509spki.c
	$(CC) /Fo$(OBJ_D)\x509spki.obj  $(SHLIB_CFLAGS) -c $(SRC_D)\crypto\x509\x509spki.c
...
$(OBJ_D)\x509_att.obj: $(SRC_D)\crypto\x509\x509_att.c
	$(CC) /Fo$(OBJ_D)\x509_att.obj  $(SHLIB_CFLAGS) -c $(SRC_D)\crypto\x509\x509_att.c
...
$(OBJ_D)\x509_trs.obj: $(SRC_D)\crypto\x509\x509_trs.c
	$(CC) /Fo$(OBJ_D)\x509_trs.obj  $(SHLIB_CFLAGS) -c $(SRC_D)\crypto\x509\x509_trs.c
...
$(OBJ_D)\v3_purp.obj: $(SRC_D)\crypto\x509v3\v3_purp.c
	$(CC) /Fo$(OBJ_D)\v3_purp.obj  $(SHLIB_CFLAGS) -c $(SRC_D)\crypto\x509v3\v3_purp.c

$(OBJ_D)\v3_info.obj: $(SRC_D)\crypto\x509v3\v3_info.c
	$(CC) /Fo$(OBJ_D)\v3_info.obj  $(SHLIB_CFLAGS) -c $(SRC_D)\crypto\x509v3\v3_info.c
...
$(OBJ_D)\conf_lib.obj: $(SRC_D)\crypto\conf\conf_lib.c
	$(CC) /Fo$(OBJ_D)\conf_lib.obj  $(SHLIB_CFLAGS) -c $(SRC_D)\crypto\conf\conf_lib.c

$(OBJ_D)\conf_api.obj: $(SRC_D)\crypto\conf\conf_api.c
	$(CC) /Fo$(OBJ_D)\conf_api.obj  $(SHLIB_CFLAGS) -c $(SRC_D)\crypto\conf\conf_api.c

$(OBJ_D)\conf_def.obj: $(SRC_D)\crypto\conf\conf_def.c
	$(CC) /Fo$(OBJ_D)\conf_def.obj  $(SHLIB_CFLAGS) -c $(SRC_D)\crypto\conf\conf_def.c
...
$(OBJ_D)\pk7_smime.obj: $(SRC_D)\crypto\pkcs7\pk7_smime.c
	$(CC) /Fo$(OBJ_D)\pk7_smime.obj  $(SHLIB_CFLAGS) -c $(SRC_D)\crypto\pkcs7\pk7_smime.c

$(OBJ_D)\pk7_attr.obj: $(SRC_D)\crypto\pkcs7\pk7_attr.c
	$(CC) /Fo$(OBJ_D)\pk7_attr.obj  $(SHLIB_CFLAGS) -c $(SRC_D)\crypto\pkcs7\pk7_attr.c

$(OBJ_D)\pk7_mime.obj: $(SRC_D)\crypto\pkcs7\pk7_mime.c
	$(CC) /Fo$(OBJ_D)\pk7_mime.obj  $(SHLIB_CFLAGS) -c $(SRC_D)\crypto\pkcs7\pk7_mime.c
...
$(OBJ_D)\p12_npas.obj: $(SRC_D)\crypto\pkcs12\p12_npas.c
	$(CC) /Fo$(OBJ_D)\p12_npas.obj  $(SHLIB_CFLAGS) -c $(SRC_D)\crypto\pkcs12\p12_npas.c
